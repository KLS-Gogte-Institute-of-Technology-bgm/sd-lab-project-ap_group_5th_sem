			...
			<header class="site-header">
				<div class="container">
					...
					<ul class="nav" style="margin-left:10px;">
						  <li class="drop">Police
		    				<ul>
						      <li><a href="policeViewComplaint.php">View Complaint</a></li>
...
?>
  <tr>
    ...
    <td><center><input type="button" value="<?php echo $rows['status']; ?>" title="Click to process" onclick="window.location.href='updatecmp.php?cmpid=<?php echo $rows['cmp_id'];?>'"></center></td>
  </tr>
  <?php $i++; } ?>
</table>
							</div>
