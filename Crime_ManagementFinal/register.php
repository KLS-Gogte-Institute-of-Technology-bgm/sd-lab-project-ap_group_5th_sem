						...
						<div class="row">
							<div class="col-md-5">
								<form action="" class="contact-form" method="POST" style="background-color:#fff !important;">
									...
									<input class="form-control" placeholder="Adhar No" maxlength="12" type="text" name="adhar" pattern="(?=.*\d)(?=.*[0-9]).{12}" title="Must contain integers with 12 digits" required>
									<input class="form-control" placeholder="Address" type="text" name="addr" required>

									<input class="form-control" placeholder="Contact No" maxlength="10" type="text" name="contact" pattern="(?=.*\d)(?=.*[0-9]).{10}" title="Must contain integers with 10 digits" required>
									...
									<input class="form-control" placeholder="Password" type="text" name="pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required>
...
if (isset($_POST['submit'])) {
	...
	$query="INSERT INTO user_reg values('0','$adharno','$fname','$address','$contact','$email','$area','$password')";
